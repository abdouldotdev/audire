# Fiches App Store localisées — Audire
...
- [Anglais — Canada (`en-CA`)](./en-CA.md) — prête
- [Anglais — Australie (`en-AU`)](./en-AU.md) — prête
- [Français — Canada (`fr-CA`)](./fr-CA.md) — prête
- [Allemand — Allemagne (`de-DE`)](./de-DE.md) — à activer après localisation de l’interface
